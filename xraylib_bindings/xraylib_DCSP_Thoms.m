function A = xraylib_DCSP_Thoms(theta,phi)
...
%
% Given a scattering polar angle theta and scattering azimuthal angle phi,
% returns the Thomson differential cross section for a polarized beam
% expressed in barn.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','DCSP_Thoms',theta,phi);
end