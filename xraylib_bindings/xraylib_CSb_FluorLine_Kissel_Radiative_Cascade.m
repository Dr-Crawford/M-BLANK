function A = xraylib_CSb_FluorLine_Kissel_Radiative_Cascade(Z, line, E)
...
% taking into account cascade effects coming from radiative transitions;
% but keep in mind that in reality both radiative and non-radiative effects
% will always be occuring simultaneously.
%
...
% sections!
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_FluorLine_Kissel_Radiative_Cascade',Z, line, E);
end