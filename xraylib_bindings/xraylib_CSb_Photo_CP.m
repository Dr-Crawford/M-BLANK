function A = xraylib_CSb_Photo_CP(comp, E)
...
% the Photoelectric cross section expressed in barn/atom.
% 
% Identical to xraylib_CS_Photo, but requires a chemical
...
% comp is a character string
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_Photo_CP', comp, E);
end
