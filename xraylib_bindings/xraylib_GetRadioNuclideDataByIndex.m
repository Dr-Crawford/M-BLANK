...
function radioNuclideData = xraylib_GetRadioNuclideDataByIndex(radioNuclideIndex)
% Name: Xraylib
% Version: 1.0.8
% Date: 2009-05-06
...
% at our online xraylib calculator: http://lvserver.ugent.be/xraylib-web/
    ...
    xraylib_loadlibrary;
    radioNuclideData = calllib('libxrl','GetRadioNuclideDataByIndex',radioNuclideIndex);
end