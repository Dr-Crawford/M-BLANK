function A = xraylib_DCSPb_Rayl_CP(comp, E, theta, phi)
...
%
% Given an element Z , energy E, a scattering polar angle theta, and
% scattering azimuthal angle phi ,returns respectively the Rayleigh
% scattering cross section expressed in barn/atom/sterad.
%
...
% formula or a NIST compound name compound as first argument.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','DCSPb_Rayl_CP',comp, E, theta, phi);
end