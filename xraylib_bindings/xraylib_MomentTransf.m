function A = xraylib_MomentTransf(E, theta)
...
%
% Given an energy E and a scattering polar angle theta , returns the
% momentum transfer for X?ray photon scattering expressed in Å .
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','MomentTransf',E, theta);
end