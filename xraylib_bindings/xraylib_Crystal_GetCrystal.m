function Crustal_Struct = xraylib_Crystal_GetCrystal(material, c_array)
...
%
% Get a pointer to a Crystal_Struct of a given crystal material from
% c_array . If c_array is NULL then the internal array of crystals is
% searched. If not found, NULL is returned. The c_array argument is only
% used in C, C++ and Fortran. The other bindings support only the internal
% array.
    ...
    %}
    xraylib_loadlibrary;
    Crustal_Struct = calllib('libxrl','Crystal_GetCrystal',material, c_array);
end