function A = xraylib_CSb_Rayl_CP(comp, E)
...
% the Rayleigh cross section expressed in barn/atom.
% 
% Identical to xraylib_CSb_Rayl, but requires a chemical
...
% comp is a character string
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_Rayl_CP', comp, E);
end
