function A = xraylib_SF_Compt(Z, q)
...
%
% Given an element Z and a momentum transfer q ?expressed in Å ?, returns
% the incoherent scattering function for Compton scattering.
