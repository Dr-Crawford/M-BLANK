function Z = xraylib_SymbolToAtomicNumber(symbol)
% Name: Xraylib
% Version: 1.0.8
% Date: 2009-05-06
...
%
% The SymbolToAtomicNumber function returns the atomic number that
% corresponds with element symbol . If the element does not exist, 0 is
% returned.

    xraylib_loadlibrary;
    Z = calllib('libxrl','SymbolToAtomicNumber',symbol);
end