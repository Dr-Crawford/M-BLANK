function A = xraylib_AtomicLevelWidth(Z, shell)
...
%
% Given an element Z and a shell?type macro shell , returns the atomic
% level width in keV.
%
% See: xraylib_macro_integer_references
    ...
    A = calllib('libxrl','AtomicLevelWidth',Z, shell);
end