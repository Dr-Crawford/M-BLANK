function A = xraylib_DCSP_KN(E, theta, phi)
...
%
% Given an energy E, a scattering polar angle theta and scattering
% azimuthal angle phi, returns the Klein?Nishina differential cross
% section for a polarized beam expressed in barn.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','DCSP_KN',E, theta, phi);
end