function A = xraylib_DCSb_Compt_CP(comp, E, theta)
...
%
% Given an element Z , energy E and a scattering polar angle theta, returns
% respectively the Compton scattering cross section expressed in
% barn/atom/sterad.
%
...
% formula or a NIST compound name compound as first argument.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','DCSb_Compt_CP',comp, E, theta);
end