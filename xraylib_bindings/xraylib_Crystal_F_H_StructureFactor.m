function xrlComplex = xraylib_Crystal_F_H_StructureFactor(Crystal_Struct, E, i_miller,j_miller, k_miller, debye_factor, rel_angle)
...
%
% Computes the Q scattering amplitude for a given crystal cryst , incident
% energy E , Miller indices ( i_miller , j_miller and k_miller ) Debye
% factor debye_factor and relative angle rel_angle . The return value is a
% complex number.
% See: Crystal_Struct is the output of xraylib_Crystal_GetCrystal.
    ...
    %}
    xraylib_loadlibrary;
    xrlComplex = calllib('libxrl','Crystal_F_H_StructureFactor',Crystal_Struct, E, i_miller,j_miller, k_miller, debye_factor, rel_angle);
end