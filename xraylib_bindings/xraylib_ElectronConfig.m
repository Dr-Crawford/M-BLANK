function A = xraylib_ElectronConfig(Z, shell)
...
%
% Given an element Z and a shell?type macro shell , returns the number of
% electrons the shell possesses.
% See: xraylib_macro_integer_references
    ...
    A = calllib('libxrl','ElectronConfig',Z, shell, pz);
end