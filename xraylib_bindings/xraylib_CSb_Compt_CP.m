function A = xraylib_CSb_Compt_CP(comp, E)
...
% the Compton cross section expressed in barn/atom.
% 
% Identical to xraylib_CS_Compt, but requires a chemical
...
% comp is a character string
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_Compt_CP', comp, E);
end
