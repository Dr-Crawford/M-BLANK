function xrlComplex = xraylib_Refractive_Index(compound, E, rho)
...
%
% Given a chemical formula compound , energy E and a density rho, returns
% both the real and imaginary parts of the refractive index. For a
% definition of xrlComplex, see the crystal diffraction section of the
% manual.
    ...
    %}
    xraylib_loadlibrary;
    xrlComplex = calllib('libxrl','Refractive_Index', compound, E, rho);
end