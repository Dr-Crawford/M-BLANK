function A = xraylib_CSb_Total_Kissel_CP(comp, E)
...
%
% 
% Identical to xraylib_CS_Total but the photoionization contribution is
% calculated using the Kissel cross sections. Given an element Z and an
% energy E (in keV), this function will return the total absorption cross
% section expressed in barn/atom.
%
%
% Identical to the earlier mentioned functions, but require a chemical
% formula or a NIST compound name compound as first argument.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_Total_Kissel_CP', comp, E);
end