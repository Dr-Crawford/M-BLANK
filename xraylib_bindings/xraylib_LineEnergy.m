function A = xraylib_LineEnergy(Z, line)
...
%
% Given an element Z and line-type macro line , returns the energy of the
% requested XRF line expressed in keV.
%
% see: xraylib_macro_integer_references
    xraylib_loadlibrary;
    integer = xraylib_macro_line2integer(line);
    A = calllib('libxrl','LineEnergy',Z, integer);
end