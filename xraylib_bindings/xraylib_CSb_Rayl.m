function A = xraylib_CSb_Rayl(Z, E)
...
% the Rayleigh scattering cross section expressed in cm2/g. Identical to
% xraylib_CS_Rayl, but the cross section is returned expressed in
% barn/atom.
    %{
