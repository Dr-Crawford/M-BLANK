...
function xraylib_FreeCompoundData(compoundData)
% Name: Xraylib
% Version: 1.0.8
% Date: 2009-05-06
...
%
% Frees allocated memory from the xraylib_CompoundParser function

    xraylib_loadlibrary;
    calllib('libxrl','FreeCompoundData',compoundData);
end