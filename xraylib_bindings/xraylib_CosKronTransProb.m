function A = xraylib_CosKronTransProb(Z, trans)
...
%
% Given an element Z and transition-type macro trans , returns the
% corresponding Coster-Kronig transition probability.
%
% See: xraylib_macro_integer_references

    xraylib_loadlibrary;
    A = calllib('libxrl','CosKronTransProb',Z, trans);
end