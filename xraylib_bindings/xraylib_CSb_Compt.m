function A = xraylib_CSb_Compt(Z, E)
...
% the Compton scattering cross section expressed in cm2/g. Identical to
% xraylib_CS_Compt, but the cross section is returned expressed in
% barn/atom.
%
% See Also:  xraylib_CS_Total CS_Photo xraylib_CS_Rayl xraylib_CS_Compt
%
%
%
    %{
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_Compt', Z, E);
end