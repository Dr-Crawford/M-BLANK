function A = xraylib_DCS_Thoms(theta)
...
%
% Given a scattering polar angle theta, returns the Thomson differential
% cross section expressed in barn.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','DCS_Thoms',theta);
end