function xrlComplex = xraylib_Crystal_UnitCellVolume(Crystal_Struct)
...
%
% Computes the unit cell volume for a crystal cryst . Structures obtained
% from the official array will have their volume in .volume
% See: Crystal_Struct is the output of xraylib_Crystal_GetCrystal.
    ...
    %}
    xraylib_loadlibrary;
    xrlComplex = calllib('libxrl','Crystal_UnitCellVolume',Crystal_Struct);
end