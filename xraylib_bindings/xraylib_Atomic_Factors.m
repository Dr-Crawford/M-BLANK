function A = xraylib_Atomic_Factors(Z, E, q, debye_factor, f0, f_prime, f_prime2)
...
%
% Computes the atomic factors f f0 , ?f? f_prime and ?f? f_prime2 for a
% given element Z , incident energy E , momentum transfer q and Debye
% factor debye_factor . f0 , f_prime and f_prime2 are pointers to doubles
% in C, C++, Fortran and IDL BUT return values in Perl, Python and Lua!!
% See: Crystal_Struct is the output of xraylib_Crystal_GetCrystal.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','Atomic_Factors',Z, E, q, debye_factor, f0, f_prime, f_prime2);
end