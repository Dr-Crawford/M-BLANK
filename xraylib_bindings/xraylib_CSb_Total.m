function A = xraylib_CSb_Total(Z, E)
...
% the total absorption cross section expressed in cm2/g. Identical to
% xraylib_CS_Total, but the cross section is returned expressed in
% barn/atom.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_Total', Z, E);
end