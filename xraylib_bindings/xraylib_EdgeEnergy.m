function A = xraylib_EdgeEnergy(Z, shell)
...
%
% Given an element Z and shell-type macro shell , returns the absorption
% edge energy expressed in keV.
%
% See: xraylib_macro_integer_references
    ...
    A = calllib('libxrl','EdgeEnergy',Z, shell);
end