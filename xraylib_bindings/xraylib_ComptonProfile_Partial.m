function A = xraylib_ComptonProfile_Partial(Z, shell, pz)
...
%
% Given an element Z , a shell?type macro shell and a momentum pz , returns
% the Compton scattering profile for a particular subshell 
% See: xraylib_macro_integer_references
    ...
    A = calllib('libxrl','ComptonProfile_Partial',Z, shell, pz);
end