function A = xraylib_CSb_Photo(Z, E)
...
% the photoionization cross section expressed in cm2/g. Identical to
% xraylib_CS_Photo, but the cross section is returned expressed in
% barn/atom.

    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_Photo', Z, E);
end