function Crustal_Struct = xraylib_Bragg_angle(Crystal_Struct, E, i_miller,j_miller, k_miller)
...
%
% Computes the Bragg angle in radians for a given crystal cryst , energy E
% and Miller indices i_miller , j_miller and k_miller .
% See: Crystal_Struct is the output of xraylib_Crystal_GetCrystal.
    ...
    %}
    xraylib_loadlibrary;
    Crustal_Struct = calllib('libxrl','Bragg_angle',Crystal_Struct, E, i_miller,j_miller, k_miller);
end