function sym1 = xraylib_AtomicNumberToSymbol(Z)
% Name: Xraylib
% Version: 1.0.8
% Date: 2009-05-06
...
%
% The AtomicNumberToSymbol function returns a pointer to a string
% containing the element for atomic number Z . If an error occurred, the
% NULL string is returned. The string should be freed after usage with the
% xrlFree function (C/C++/Obj?C and Fortran only).

    xraylib_loadlibrary;
    sym1 = calllib('libxrl','AtomicNumberToSymbol',Z);
end