function A = xraylib_CS_FluorLine_Kissel_Nonradiative_Cascade(Z, line, E)
...
% XRF cross section expressed in cm2/g calculated using the partial
...
% sections!
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CS_FluorLine_Kissel_Nonradiative_Cascade',Z, line, E);
end