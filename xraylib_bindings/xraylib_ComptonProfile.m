function A = xraylib_ComptonProfile(Z, pz)
...
%
% Given an element Z and a momentum pz ?expressed in atomic units?, returns
% the Compton scattering profile summed over all shells.
%
% See: xraylib_macro_integer_references
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','ComptonProfile',Z, pz);
end