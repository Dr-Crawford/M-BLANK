function A = xraylib_CSb_FluorLine_Kissel_Cascade(Z, line, E)
...
% taking into account cascade effects, both those coming from radiative
% transitions and those from non?radiative transitions.
%
...
% sections!
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','CSb_FluorLine_Kissel_Cascade',Z, line, E);
end