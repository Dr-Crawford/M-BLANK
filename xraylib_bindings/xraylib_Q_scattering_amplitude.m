function Crustal_Struct = xraylib_Q_scattering_amplitude(Crystal_Struct, E, i_miller,j_miller, k_miller, rel_angle)
...
% energy E , Miller indices ( i_miller , j_miller and k_miller ) and
...
% See: Crystal_Struct is the output of xraylib_Crystal_GetCrystal.
    ...
    %}
    xraylib_loadlibrary;
    Crustal_Struct = calllib('libxrl','Q_scattering_amplitude',Crystal_Struct, E, i_miller,j_miller, k_miller, rel_angle);
end