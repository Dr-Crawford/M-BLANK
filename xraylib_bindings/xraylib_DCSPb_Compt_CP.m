function A = xraylib_DCSPb_Compt_CP(comp, E, theta, phi)
...
% scattering azimuthal angle phi, returns respectively the Compton
% scattering cross section expressed in bar/atom/sterad.
%
...
% formula or a NIST compound name compound as first argument.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','DCSPb_Compt_CP',comp, E, theta, phi);
end