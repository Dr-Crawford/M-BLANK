function A = xraylib_AugerRate(Z, auger)
...
%
% Given an element Z and an Auger?type macro auger corresponding with the
% electrons involved, returns the non?radiative rate.
%
    %{
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','AugerRate', Z, auger);
end