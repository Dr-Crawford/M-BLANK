function A = xraylib_DCS_KN(E, theta)
...
%
% Given an energy E (in keV) and a scattering polar angle theta , returns
% the Klein?Nishina differential scattering cross section expressed in
% barn.
    ...
    %}
    xraylib_loadlibrary;
    A = calllib('libxrl','DCS_KN',E, theta);
end