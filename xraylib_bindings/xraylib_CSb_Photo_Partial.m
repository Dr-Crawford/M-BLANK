function A = xraylib_CSb_Photo_Partial(Z, shell, E)
...
% the partial photoionization cross section expressed in barn/electron.
% 
...
%
    ...
    A = calllib('libxrl','CSb_Photo_Partial', Z, shell, E);
end
