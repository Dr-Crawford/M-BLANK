function A = xraylib_CS_FluorLine_Kissel(Z, line, E)
...
% photoelectric effect cross sections calculated by Kissel et al.
%
...
% sections!
    ...
    xraylib_loadlibrary;
    integer = xraylib_macro_line2integer(line);
    A = calllib('libxrl','CS_FluorLine_Kissel',Z, integer, E);
end